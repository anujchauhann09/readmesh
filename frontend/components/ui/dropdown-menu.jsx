...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[11rem] overflow-hidden rounded-lg border border-border/80 bg-popover/85 p-1.5 text-popover-foreground shadow-[0_24px_60px_-24px_rgb(0_0_0/0.6)] backdrop-blur-xl data-[state=open]:rm-fade-in',
        className,
      )}
      {...props}
    />
